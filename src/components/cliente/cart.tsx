...
export function Cart() {
  ...
  const [enteredViaQr,setEnteredViaQr]=useState(false);
  ...
  useEffect(() => {
    ...
    try{setEnteredViaQr(JSON.parse(localStorage.getItem("ditus-table-access")??"null")?.viaQr===true)}catch{setEnteredViaQr(false)}
